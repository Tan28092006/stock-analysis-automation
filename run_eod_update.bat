...
git add data/raw/prices_hist data/raw/foreign data/pipeline/momentum_scan_cache.json data/pipeline/mr_scan_cache.json data/pipeline/daily_runs.jsonl data/pipeline/pending_predictions.jsonl >> data\pipeline\eod_update.log 2>&1
